...
function extractManifestSchemaTypes(schema) {
    const typeNames = schema.getTypeNames(), studioDefaultTypeNames = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$Rule$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Schema"].compile({
        name: "default",
        types: builtinTypes
    }).getTypeNames();
...
function transformValidation(validation) {
    const validationArray = (Array.isArray(validation) ? validation : [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$Rule$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Rule"].FIELD_REF
